                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="shadow-premium transition-noir relative flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden bg-white">
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            ...
                            {/* Order Summary */}
                            <div className="shadow-soft mb-6 border border-gray-200 bg-white">
                                <div className="border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white px-4 py-3">
                                    <h3 className="flex items-center gap-2 font-sans text-base font-bold tracking-wide text-black uppercase">
                                        <CreditCard
                                            className="h-4 w-4"
                                ...
                                <div className="p-4">
                                    <div className="space-y-2 bg-gradient-to-br from-gray-50 to-white p-4">
                                        <div className="flex justify-between text-sm">
                                            <span className="font-sans font-semibold tracking-wider text-gray-600 uppercase">
                                        ...
                                        <div className="border-t-2 border-black pt-2">
                                            <div className="flex justify-between text-lg">
                                                <span className="font-sans font-bold tracking-wide text-black uppercase">
                                                    Total Amount:
                                                </span>
